...
import React from 'react'
 ...
 const Message = ({ alertmessage , type, btnclose, visibility }) => {
 

return (
  <>
  <div className={"alert alert-"+type+" "+visibility+" max-w-sm mx-auto flex justify-between "}>

  <div className="flex items-center gap-1">

  {type == "error" ? (
      <svg className='my-auto' width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <button className={'  btn btn-xs self-start btn-'+type} onClick={btnclose}>
